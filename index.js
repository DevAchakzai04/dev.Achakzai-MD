  ...
  if (!client.authState.creds.registered) {
    const phoneNumber = await question(
      chalk.bgYellowBright.blueBright.bold(`WARNING`) +
        ...
        " " +
        chalk.white("Example: 923308363433") +
        chalk.yellow("\n---> ")
    );
    try {
