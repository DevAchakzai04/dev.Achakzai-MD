...
Always mention the user by name using ${userName} to make them feel special. Use many emojis in your responses.`
      ...
      if (!response || response === "-") {
        return client.reply(m.chat, '✐ Could not get a valid *response* from Achakzai 04.', m)
      }
      ...
      console.error(error)
      await m.reply('❌ Error connecting to Achakzai 04.')
    }
  },
}