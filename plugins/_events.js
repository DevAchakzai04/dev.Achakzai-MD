        ...
        const smallThumbContext = {
          contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
              ...
              serverMessageId: '0',
              newsletterName: global.db.data.settings[botId]?.nameid || 'Achakzai 04'
            },
            externalAdReply: {
              title: global.db.data.settings[botId]?.namebot || 'Achakzai 04',
              body: global.dev || 'Automatic Notification',
              mediaUrl: null,
              description: null,
              previewType: 'PHOTO',
              thumbnailUrl: global.db.data.settings[botId]?.icon || pp,
              sourceUrl: global.db.data.settings[botId]?.link || 'https://github.com/I',
              mediaType: 1,
        ...
        const normalThumbContext = {
          contextInfo: {
            ...
            externalAdReply: {
              ...
              previewType: 'PHOTO',
              thumbnailUrl: global.db.data.settings[botId]?.icon || pp,
              sourceUrl: global.db.data.settings[botId]?.link || 'https://github.com/',
              mediaType: 1,
...
╰─⊷ ${global.db.data.settings[botId]?.namebot || 'Achakzai 04'} ⊶─╯`
