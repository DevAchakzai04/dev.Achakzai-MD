  ...
  run: async (client, m, args) => {
    try {
      ...
      if (!isYTUrl(query)) {
        ...
        if (!search.all.length) return m.reply('🥀 *Sorry,* \n> The bot couldn\'t find results for that search.')
      ...
      if (result.success && result.data && result.data.result && result.data.result.urls) {
        ...
        const infoMessage = `✨ ──Achakzai 04── ✨\n\n`
          + `🎵 *ᴀᴜᴅɪᴏ ʀᴇᴀᴅʏ!*\n\n`
          + `• 🏷️ *ᴛɪᴛᴛʟᴇ:* ${finalTitle}\n`
          + `• 🎙️ *ᴄʜᴀɴɴᴇʟ:* ${finalChannel}\n`
          + `• ⏳ *ᴅᴜʀᴀᴛɪᴏɴ:* ${finalDuration}\n`
          + `• 👀 *ᴠɪᴇᴡs:* ${finalViews}\n`
          + `• ❤️ *ʟɪᴋᴇs:* ${finalLikes}\n\n`
          + `> 🎶 *Achakzai 04 sᴏɴɢ*`
