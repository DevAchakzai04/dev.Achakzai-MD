      ...
      const menuButtons = [
        ...
        },
        {
          ...
          buttonParamsJson: JSON.stringify({
            ...
            url: global.bot.channel || 'https://whatsapp.com/channel/0029VbCf0uq9xVJbJhdYjC27'
          })
        },
        {
          name: 'cta_url',
          buttonParamsJson: JSON.stringify({
            ...
            url: global.bot.group || 'https://chat.whatsapp.com/LGhlAx9Z6aBEvkhNoUgH30?mode=gi_t'
          })
        },
        {
          name: 'cta_url',
          buttonParamsJson: JSON.stringify({
            ...
            url: global.bot.github || 'https://github.com/'
          })
        }
      ]
  ...
  if (selectedId === 'menu_stats') {
    ...
    await client.sendInteractiveButtons(m.chat, {
      ...
      interactiveButtons: [
        {
          name: 'cta_url',
          buttonParamsJson: JSON.stringify({ display_text: '📱 WhatsApp Channel', url: global.bot.channel || 'https://whatsapp.com/channel/0029VbCf0uq9xVJbJhdYjC27' })
        },
        {
          name: 'cta_url',
          buttonParamsJson: JSON.stringify({ display_text: '💬 Support Group', url: global.bot.group || 'https://chat.whatsapp.com/LGhlAx9Z6aBEvkhNoUgH30?mode=gi_t' })
        },
        {
          name: 'cta_url',
          buttonParamsJson: JSON.stringify({ display_text: '🐙 GitHub Repository', url: global.bot.github || 'https://github.com' })
        }
      ]
    })
