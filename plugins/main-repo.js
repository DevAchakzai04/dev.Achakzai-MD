...
const REPO_OWNER = 'Achakzai 04';
const REPO_NAME = 'Achakzai 04';
...
export default {
  ...
  run: async (client, m) => {
    try {
      ...
      const botname = botSettings.namebot2 || 'Achakzai 04';
      ...
      const description = repoInfo.description || 'Achakzai 04 - Advanced WhatsApp Bot with Gacha, Economy, AI and more!';
      ...
      const commitAuthor = lastCommit ? lastCommit.author : 'Achakzai 04';
...
🔗 *ʟɪɴᴋs:*
┣ 🌐 *Repository:* ${REPO_URL}
┣ 📢 *Channel:* https://whatsapp.com/channel/0029VbCf0uq9xVJbJhdYjC27
┗ 💬 *Group:* https://chat.whatsapp.com/LGhlAx9Z6aBEvkhNoUgH30?mode=gi_t

> ✨ * this repository is still private!* ✨`;
...
💬 *WhatsApp Group:*
https://chat.whatsapp.com/LGhlAx9Z6aBEvkhNoUgH30?mode=gi_t

> ✨ *The repository on GitHub is still private!* ✨`;
