export default {
  ...
  run: async (client, m, args) => {
    ...
    if (!value) return m.reply(`✐ You must enter a valid status.\n> Example: *${prefa}setstatus Hello! I am Deve.Achakzai 04*`)
    await client.updateProfileStatus(value)
    return m.reply(` The bot status has been updated to *${value}*!`)
  },
};