...
function initDB(m, client) {
  ...
  settings.self ??= false
  settings.prefijo ??= ['/', '.', '#', '!']
  settings.id ??= '120363423640651952@newsletter'  // Newsletter ID
  settings.nameid ??= 'Achakzai 04'
  settings.link ??= ''
  settings.banner ??= 'https://filesbox.moe/9jbw55.jpg'
  
  settings.icon ??= ''
  settings.currency ??= 'Coins'
  settings.namebot ??= 'Achakzai 04'
  settings.namebot2 ??= 'Achakzai MD'
  settings.owner ??= 'Achakzai 04 - 923308363433'
